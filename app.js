...
const fitnessData = [
    // --- KRACHT ---
    {
        ...
        uitvoering: ["Plaats je handen achter je op een stevige stoelrand.", "Strek je benen of houd je knieën gebogen voor een lichtere variant.", "Zak door je armen tot een hoek van 90 graden.", "Duw jezelf weer omhoog."],
    ...
    },
    {
        ...
        uitvoering: ["Voeten op schouderbreedte, tenen iets naar buiten.", "Zak langzaam alsof je op een stoel gaat zitten.", "Houd borst vooruit, rug recht.", "Duw krachtig omhoog vanuit je hakken."],
    ...
    },
    {
        ...
        uitvoering: ["Steun op je onderarmen en tenen.", "Houd je lichaam in een kaarsrechte lijn.", "Span je buik- en bilspieren stevig aan.", "Houd deze positie vast zolang je vorm perfect blijft."],
    ...
    },
    {
        ...
        uitvoering: ["Handen iets breder dan schouderbreedte.", "Steun op je knieën in een rechte plank.", "Zak gecontroleerd met je borst naar de vloer.", "Duw krachtig omhoog."],
    ...
    },
    {
        ...
        uitvoering: ["Ga plat op je buik liggen, armen vooruit gestrekt.", "Til je armen, borst en benen tegelijkertijd een stukje van de vloer.", "Houd 2 seconden vast in de lucht.", "Laat weer rustig zakken."],
    ...
    },
    {
        ...
        uitvoering: ["Plaats je handen en voeten op de grond en maak een omgekeerde 'V' (hond-houding).", "Buig je armen en laat je kruin gecontroleerd richting de vloer zakken.", "Duw jezelf schuin omhoog terug in de 'V'.", "Houd je core strak."],
    ...
    // --- LENIGHEID ---
    {
        ...
        uitvoering: ["Ga rechtop staan met je armen zijwaarts gestrekt.", "Maak kleine cirkelende bewegingen naar voren.", "Maak de cirkels langzaam groter.", "Draai na 30 seconden de andere kant op."],
    ...
    },
    {
        ...
        uitvoering: ["Zet één knie op de grond en je andere voet voor je (90 graden hoek).", "Duw je heupen zachtjes naar voren en omlaag.", "Houd je bovenlichaam rechtop.", "Houd 30 seconden vast en wissel."],
    ...
    },
    {
        ...
        uitvoering: ["Ga in een deuropening staan.", "Plaats je onderarmen op het kozijn, ellebogen op schouderhoogte.", "Leun zachtjes naar voren tot je rek voelt in je borst.", "Houd 20-30 seconden vast."],
    ...
    {
        type: "Lenigheid", spiergroep: "Beenspieren (Hamstrings)", naam: "Actieve Hamstring Rek", doelspier: "Achterkant bovenbeen",
        uitvoering: ["Ga op je rug liggen met één been gestrekt.", "Pak je andere been achter de knie vast en trek deze naar je borst.", "Strek je onderbeen langzaam uit omhoog.", "Buig en strek dit 10 keer."],
